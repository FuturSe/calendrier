...
<div class="calendar">
    ...
    <div class="d-flex flex-row align-items-center justify-content-between mx-sm-3">
        ...
        <?php endif; ?>
        <div>
            <a href="/index.php?month=<?= $month->previoustMonth()->month;?> &year=<?= $month->previoustMonth()->year;?>" class="btn btn-primary">&lt;</a>
            ...
            <?php for ($i = 0 ; $i< $weeks; $i++):?>
                <tr>
                    ...
                    <td class="<?=$month->withinMonth($date)?' ' : 'calendar_othermonth';?> <?= $isToday ? 'is-today':'';?>">
                        ...
                        <?php endif ;?> 
                        <a class="calendar_day" href="add.php?date=<?= $date->format('Y-m-d');?>"><?= $date->format('d');?></a>
